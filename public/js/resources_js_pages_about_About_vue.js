...
var _hoisted_3 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    id: "about_paragraph"
  }, " Здравейте, казвам се Дамяна Стайкова. През 2016 година завърших Професионална гимназия по облекло \"Ана Май\" в град Пловдив и оттогава работя като стилист. Очарованa съм как работата ми може напълно да промени не само начина, по който хората изглеждат, но и как се чувстват към себе си. Непрекъснато работя върху усъвършенстване на уменията си, научавам нови техники, експериментирам и съм в крак с актуалните тенденции. Работила съм с всички типове коса, обичам да правя различни прически и процеса на намиране на собствен стил на клиента. ")], -1
  /* HOISTED */
  );
});
